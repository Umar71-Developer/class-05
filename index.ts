...
var obtainedMarks:number=654
var totalMarks:number= 1100

var percentage:number= (obtainedMarks/1100)*100
...
var inputDays:number=75;
var daysIntoWeeks:number=inputDays/7;
...
var givenPriceItem:number=100;
var discount10:number=10/givenPriceItem*100;
var discount5:number=5/givenPriceItem*100;
if (givenPriceItem>=200) {console.log("10% discount" ,givenPriceItem-discount10);

    
}
else{console.log("5% discount",givenPriceItem-discount5);
}
...
var age:number=51;
if (age>=0 && age<=12) {console.log("you are a Child");
